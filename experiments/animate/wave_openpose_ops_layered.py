...
with open(path.join("operations", "examples", "wave_openpose_conventional.p"), "rb") as f:
    ops_conventional = pickle.load(f)

with open(path.join("operations", "examples", "wave_openpose_event.p"), "rb") as f:
...
op_line(
    [shallow, middle, deep],
    path.join("animations", "wave_openpose_ops_layered.mp4"),
